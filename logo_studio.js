(function () {
    ...
    // 1. Инициализация хранилища настроек Lampa
    ...
    Lampa.Settings.add({
        title: 'Студии',
        type: 'book',
        icon: '<svg height="36" viewBox="0 0 24 24" width="36" xmlns="http://www.w3.org/2000/svg"><path d="M12 7V3H2v18h20V7H12zM6 19H4v-2h2v2zm0-4H4v-2h2v2zm0-4H4V9h2v2zm0-4H4V5h2v2zm4 12H8v-2h2v2zm0-4H8v-2h2v2zm0-4H8V9h2v2zm0-4H8V5h2v2zm10 12h-8v-2h2v-2h-2v-2h2v-2h-2V9h8v10z"/></svg>',
    ...
    // 3. Динамические стили (обновляются при изменении настроек)
    function updateStyles() {
        ...
        var styles = `
            ...
            .rate--studio.studio-logo img { height: ${size} !important; width: auto; object-fit: contain; }
    ...
    function renderStudiosTitle(render, movie) {
        ...
        updateStyles(); // Обновляем стили перед отрисовкой
